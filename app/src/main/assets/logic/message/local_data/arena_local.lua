...
function g_msg_arena_local.cg_arena_request_player_list()
	...
	_timerId = timer.create("g_msg_arena_local.gc_arena_sync_player_list", 1000, 1);
end
...
function g_msg_arena_local.cg_arena_request_fight_report()
	_timerId = timer.create("g_msg_arena_local.gc_arena_request_fight_report", 1000, 1);
end
...
function g_msg_arena_local.cg_arena_request_myslef_info()
	_timerId = timer.create("g_msg_arena_local.gc_arena_sync_myself_info", 1000, 1);
end
