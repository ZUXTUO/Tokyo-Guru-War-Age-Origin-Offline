...
function CardHuman:initData(data)
    ...
    self.hp_point = data.hp_point or 0;
    self.phy_at_point = data.phy_at_point or 0;
    self.energy_at_point = data.energy_at_point or 0;
    self.phy_def_point = data.phy_def_point or 0;
    self.energy_def_point = data.energy_def_point or 0;
    self.neidan_level = data.neidan_level or 0;
    self.neidan_defense_level = data.neidan_defense_level or 0
    self.neidan_attack_level = data.neidan_attack_level or 0
    self.neidan_physical_level = data.neidan_physical_level or 0
    self.surplus_point = data.surplus_point or 0;
    self.contact_hp_per = data.contact_hp_per or 0;
    self.contact_attack_per = data.contact_attack_per or 0;
    self.contact_def_per = data.contact_def_per or 0;
    self.team_add = 0;
    self.dataSource = data.dataSource or g_dataCenter.package;
	self.trainingHallLevel = data.trainingHallLevel or 0;
	self.trainingHallLevelExp = data.trainingHallLevelExp or 0;
    ...
    self.equipment = { };
	-- 装备达人等级
	self.equip_expert_normal_rarity_level = data.equip_expert_normal_rarity_level or 0;
	self.equip_expert_exclusive_rarity_level = data.equip_expert_exclusive_rarity_level or 0;
	self.equip_expert_normal_star_level = data.equip_expert_normal_star_level or 0;
	self.equip_expert_exclusive_star_level = data.equip_expert_exclusive_star_level or 0;
...
function CardHuman:CanSkillLevel()
    ...
    for i, v in ipairs(self.config.spe_skill) do
        local learnSkill = self.learn_skill[i];
