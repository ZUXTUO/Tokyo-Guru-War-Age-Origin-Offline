...
.method private getPinyin(C)Ljava/lang/String;
    ...
    .prologue
    .line 122
    sget-boolean v2, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->isLoad:Z
    ...
    .line 137
    .local v1, "pos":I
    sget-object v2, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->PINYIN:[Ljava/lang/String;
...
.method private static loadData(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-boolean v5, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->isLoad:Z
    :try_end_0
    ...
    sput-object v5, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->sPinyinIndex:[S
    ...
    .local v3, "i":I
    :goto_1
    sget-object v5, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->sPinyinIndex:[S
    ...
    sput-boolean v5, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->isLoad:Z
    :try_end_3
...
.method public getMatchedResult(Ljava/lang/String;Ljava/lang/String;)Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;
    ...
    .prologue
    .line 162
    new-instance v20, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;

    invoke-direct/range {v20 .. v20}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;-><init>()V

    .line 163
    .local v20, "result":Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;
    const/4 v2, -0x1

    move-object/from16 v0, v20

    iput v2, v0, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;->start:I
    ...
    iput v2, v0, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;->end:I
    ...
    iput v15, v0, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;->start:I
    ...
    invoke-direct {v0, v1, v14, v2}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->subCharRangeArray([CII)[C
    ...
    invoke-direct {v0, v13, v14, v2}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->subStringRangeArray([Ljava/lang/String;II)[Ljava/lang/String;
    ...
    .line 218
    invoke-virtual/range {v2 .. v8}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->distinguish([CI[C[Ljava/lang/String;II)I
    ...
    iput v14, v0, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils$MatchedResult;->start:I
    ...
    .end local v10    # "ch1":C
    .end local v11    # "ch2":C
    .end local v12    # "firstSearch":C
    .end local v13    # "fullPinyin":[Ljava/lang/String;
    .end local v17    # "org":[C
    .end local v19    # "pos":I
    .end local v21    # "srcLen":I
    :cond_5
    move-object/from16 v0, p2
    ...
    .line 199
    .restart local v13    # "fullPinyin":[Ljava/lang/String;
    .restart local v17    # "org":[C
    .restart local v21    # "srcLen":I
    :cond_6
    move-object/from16 v0, p1
    ...
    invoke-direct {v0, v9}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->getPinyin(C)Ljava/lang/String;
    ...
    .restart local v10    # "ch1":C
    .restart local v11    # "ch2":C
    .restart local v12    # "firstSearch":C
...
.method public getPinyin(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 156
    .local v0, "c":C
    invoke-direct {p0, v0}, Lcom/sina/weibo/sdk/register/mobile/PinyinUtils;->getPinyin(C)Ljava/lang/String;
